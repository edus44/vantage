...
contents for the open document in the margin to its left. Every heading is listed and indented by
level; clicking one jumps to it and updates the address bar, so the link is
ready to copy. The heading you are currently reading stays highlighted, and the
table of contents stays put as the document scrolls under it.
